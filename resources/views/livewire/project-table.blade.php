<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
            ...
            <p class="text-3xl font-medium text-orange-500  bg-gradient-to-r from-secondary-300 via-secondary-400 to-secondary-400 dark:text-white container mx-auto px-4 py-5">Projetos de Investimento
            </p>
            ...
            <table class="w-full border-collapse">
                <thead>
                    <tr class="bg-primary-500">
                        ...
                        <th class="p-4 cursor-pointer text-center" x-on:click="sortBy('departmants')">Departamentos</th>
                        <th class="p-4 cursor-pointer text-center" x-on:click="sortBy('departmants')">Editar</th>
                    </tr>
                </thead>
                <tbody>
