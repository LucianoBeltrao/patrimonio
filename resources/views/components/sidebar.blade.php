<div>
    ...
    <aside id="sidebar-multi-level-sidebar"
        ...
        aria-label="Sidebar">
        <div class="h-full px-3 py-4 overflow-y-auto bg-gradient-to-r text-white from-secondary-100 via-secondary-200 to-secondary-300 ">
            <ul class="space-y-2 font-medium">
                <!-- Logo -->
                <div class="shrink-8 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <div>
                            <img class="h-auto max-w-full rounded-lg" src="{{ asset('images/logo.jpg') }}"
                ...
                <li>
                    <a href="{{ route('projects') }}" :active="request()->routeIs('projects')"
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Projetos</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('assets') }}" :active="request()->routeIs('assets')"
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            viewBox="0 0 20 20">
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Ativos</span>
                        <span
                ...
                <li>
                    <a href="{{ route('designations') }}" :active="request()->routeIs('designations')"
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            viewBox="0 0 18 20">
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Alocação de Ativos</span>
                    </a>
                </li>
            </ul>
        </div>
